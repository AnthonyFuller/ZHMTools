...
void ZHMEnums::RegisterEnums()
{
	...
	(*g_Enums)["EUIIconLibrary"] = {
		...
		{ 17, "carriedweapon" },
		{ 18, "challenge" },
		{ 19, "challenge_category_assassination" },
		{ 20, "challenge_category_discovery" },
		{ 21, "challenge_category_feats" },
		{ 22, "challenge_category_item" },
		{ 23, "challenge_category_targets" },
		{ 24, "check" },
		{ 25, "civilians" },
		{ 26, "closerange" },
		{ 27, "completed" },
		...
		{ 57, "emote" },
		{ 58, "escalation" },
		{ 59, "evergreen_camera_caught" },
		{ 60, "evergreen_camera_destroy" },
		{ 61, "evergreen_camera_destroy_recorder" },
		{ 62, "evergreen_check" },
		{ 63, "evergreen_contracts" },
		{ 64, "evergreen_dead_body_disposal" },
		{ 65, "evergreen_dead_body_disposal_timed" },
		{ 66, "evergreen_destination_not_owned" },
		{ 67, "evergreen_do_not_get_spotted" },
		{ 68, "evergreen_do_not_initiate_combat" },
		{ 69, "evergreen_do_not_take_any_damage" },
		{ 70, "evergreen_failed" },
		{ 71, "evergreen_gamemode" },
		{ 72, "evergreen_gear" },
		{ 73, "evergreen_gearcost" },
		{ 74, "evergreen_gearcost_1" },
		{ 75, "evergreen_gearcost_2" },
		{ 76, "evergreen_gearcost_3" },
		{ 77, "evergreen_gearcost_4" },
		{ 78, "evergreen_gearcost_5" },
		{ 79, "evergreen_gearcost_6" },
		{ 80, "evergreen_gearcost_7" },
		{ 81, "evergreen_gearcost_8" },
		{ 82, "evergreen_gearcost_9" },
		{ 83, "evergreen_item_removed_from_safehouse_wall" },
		{ 84, "evergreen_kill_method_accident" },
		{ 85, "evergreen_kill_method_accident_burn" },
		{ 86, "evergreen_kill_method_assault_rifle" },
		{ 87, "evergreen_kill_method_axe" },
		{ 88, "evergreen_kill_method_drown" },
		{ 89, "evergreen_kill_method_electric" },
		{ 90, "evergreen_kill_method_explosive" },
		{ 91, "evergreen_kill_method_fiber_wire" },
		{ 92, "evergreen_kill_method_headshots_only" },
		{ 93, "evergreen_kill_method_melee" },
		{ 94, "evergreen_kill_method_oil_puddle" },
		{ 95, "evergreen_kill_method_pistol" },
		{ 96, "evergreen_kill_method_pistol_silenced" },
		{ 97, "evergreen_kill_method_poison" },
		{ 98, "evergreen_kill_method_push" },
		{ 99, "evergreen_kill_method_shotgun" },
		{ 100, "evergreen_kill_method_smg" },
		{ 101, "evergreen_kill_method_sniper" },
		{ 102, "evergreen_kill_method_throw" },
		{ 103, "evergreen_kill_method_unarmed" },
		{ 104, "evergreen_kill_method_wallbang" },
		{ 105, "evergreen_kill_method_water_puddle" },
		{ 106, "evergreen_merces" },
		{ 107, "evergreen_mules" },
		{ 108, "evergreen_no_bodies_found" },
		{ 109, "evergreen_no_compromised_disguises" },
		{ 110, "evergreen_no_disguise_change" },
		{ 111, "evergreen_no_lockpick" },
		{ 112, "evergreen_no_missed_shots" },
		{ 113, "evergreen_only_kill_targets" },
		{ 114, "evergreen_optin_killmethod" },
		{ 115, "evergreen_optin_showdown" },
		{ 116, "evergreen_optin_silentassassin" },
		{ 117, "evergreen_optin_speedrun" },
		{ 118, "evergreen_pacify_raremelee" },
		{ 119, "evergreen_payout" },
		{ 120, "evergreen_safe" },
		{ 121, "evergreen_safehouse_cosmetic" },
		{ 122, "evergreen_safehouse_unlock" },
		{ 123, "evergreen_search_locate" },
		{ 124, "evergreen_showdown_mission" },
		{ 125, "evergreen_suppliers" },
		{ 126, "evergreen_tags" },
		{ 127, "evergreen_target" },
		{ 128, "exit" },
		{ 129, "explosive" },
		{ 130, "explosives" },
		{ 131, "extendedmag" },
		...
		{ 195, "onemanarmy" },
		{ 196, "online" },
		{ 197, "opportunitycompleted" },
		{ 198, "opportunitydisabled" },
		{ 199, "opportunitydiscovered" },
		{ 200, "opportunityfailed" },
		{ 201, "opportunitysearch" },
		{ 202, "opportunitytracked" },
		{ 203, "opportunityundiscovered" },
		{ 204, "outbreak" },
		{ 205, "piercing" },
		{ 206, "pistol" },
		{ 207, "planning" },
		...
		{ 267, "variable" },
		{ 268, "versatilescope" },
		{ 269, "versatilescope_1" },
		{ 270, "versatilescope_2" },
		{ 271, "versatilescope_3" },
		{ 272, "versatilescope_4" },
		{ 273, "versatilescopeextended" },
		{ 274, "versus" },
		{ 275, "vr" },
		{ 276, "warning" },
		{ 277, "weapon" },
	...
	(*g_Enums)["JSONTemplate.ETemplateType"] = {
		...
		{ 39, "ETT_STOREREGION" },
		{ 40, "ETT_STORE" },
		{ 41, "ETT_IS_DISC_RELEASE" },
		{ 42, "ETT_ISDEBUG" },
		{ 43, "ETT_INPUTCONTROLLERTYPE" },
		{ 44, "ETT_IS_CONTROLLER_AVAILABLE" },
		{ 45, "ETT_IS_KEYBOARD_AVAILABLE" },
		{ 46, "ETT_IS_VR_DEVICE_AVAILABLE" },
		{ 47, "ETT_IS_VR_DEVICE_ACTIVE" },
		{ 48, "ETT_IS_VR_ACTIVE" },
		{ 49, "ETT_VR_MODE" },
		{ 50, "ETT_ONLINE_RESOURCE" },
		{ 51, "ETT_INCLUDE" },
		{ 52, "ETT_UI_OPTION_VALUE" },
		{ 53, "ETT_UI_OPTION_DEFAULT_VALUE" },
		{ 54, "ETT_UI_OPTION_DEBUG_VALUE" },
		{ 55, "ETT_UI_OPTION_AVAILABLE_DISPLAY_RESOLUTIONS" },
		{ 56, "ETT_UI_OPTION_AVAILABLE_DISPLAY_FULLSCREEN" },
		{ 57, "ETT_UI_OPTION_AVAILABLE_MOTION_BLUR" },
		{ 58, "ETT_UI_OPTION_AVAILABLE_TEXTURE_QUALITY" },
		{ 59, "ETT_UI_OPTION_AVAILABLE_SHADOW_QUALITY" },
		{ 60, "ETT_UI_OPTION_AVAILABLE_SUPERSAMPLING" },
		{ 61, "ETT_UI_OPTION_AVAILABLE_DOUBLEFRAMERATE" },
		{ 62, "ETT_UI_OPTION_AVAILABLE_VRS" },
		{ 63, "ETT_UI_OPTION_CAN_CHANGE_DISPLAY_RESOLUTION" },
		{ 64, "ETT_CURRENT_CONTRACT_CONTEXT" },
		{ 65, "ETT_CURRENT_CONTRACT_OBJECTIVES" },
		{ 66, "ETT_CURRENT_CONTRACT_SESSIONID" },
		{ 67, "ETT_CURRENT_CONTRACT_CHARACTER_INFO" },
		{ 68, "ETT_CURRENT_CONTRACT_TRACKED_OPPORTUNITY" },
		{ 69, "ETT_CURRENT_DIFFICULTY" },
		{ 70, "ETT_CURRENT_ENGINE_MODE" },
		{ 71, "ETT_CURRENT_GAME_MODE" },
		{ 72, "ETT_CAN_SAVE" },
		{ 73, "ETT_IS_SAVELIMIT_EXCEEDED" },
		{ 74, "ETT_IS_ALLOWED_TO_RESTART" },
		{ 75, "ETT_ACTIVE_CHALLENGES" },
		{ 76, "ETT_USER" },
		{ 77, "ETT_ISUSER" },
		{ 78, "ETT_DLCCOUNT" },
		{ 79, "ETT_PROFILEID" },
		{ 80, "ETT_HDRGAMMAVALUERANGEMIN" },
		{ 81, "ETT_HDRGAMMAVALUERANGEMAX" },
		{ 82, "ETT_HDRGAMMAVALUESTEP" },
		{ 83, "ETT_ISDLSSAVAILABLE" },
		{ 84, "ETT_ISXESSAVAILABLE" },
		{ 85, "ETT_ISXESSINSTALLED" },
		{ 86, "ETT_ISHDRAVAILABLE" },
		{ 87, "ETT_ISHDRRENDERING" },
		{ 88, "ETT_ISRAYTRACINGAVAILABLE" },
		{ 89, "ETT_VARIABLERATESHADINGTIER" },
		{ 90, "ETT_ITEM" },
		{ 91, "ETT_REPOSITORY" },
		{ 92, "ETT_ISONLINE" },
		{ 93, "ETT_ISINGAME" },
		{ 94, "ETT_ISINEDITOR" },
		{ 95, "ETT_ISUGCRESTRICTED" },
		{ 96, "ETT_ISPACKAGEOWNED" },
		{ 97, "ETT_ISININVENTORY" },
		{ 98, "ETT_ISPLATFORMENTITLEMENTOWNED" },
		{ 99, "ETT_MULTIPLAYERLOBBYSTATE" },
		{ 100, "ETT_MULTIPLAYERLOCALID" },
		{ 101, "ETT_MULTIPLAYERJOINEDIDS" },
		{ 102, "ETT_MULTIPLAYERISPLAYERREADY" },
		{ 103, "ETT_MULTIPLAYERINFO" },
		{ 104, "ETT_MULTIPLAYERMATCHMAKINGTIME" },
		{ 105, "ETT_MULTIPLAYERNATTYPE" },
		{ 106, "ETT_LOADOUT" },
		{ 107, "ETT_LOADOUT_SLOT" },
		{ 108, "ETT_LOADOUT_AGENCY_PICKUP" },
		{ 109, "ETT_LOADOUT_SELECTED_ENTRANCE" },
		{ 110, "ETT_PERSISTENTMENUDATA" },
		{ 111, "ETT_GAMEPERSISTENTDATA" },
		{ 112, "ETT_ENDGAME_PAGETRANSITION_OVERRIDE" },
		{ 113, "ETT_VERSUSINFO" },
		{ 114, "ETT_SNIPERINFO" },
		{ 115, "ETT_GAMEMODE" },
		{ 116, "ETT_CACHEDUSERCENTRICCONTRACT" },
		{ 117, "ETT_SAVEGAMES" },
		{ 118, "ETT_AVAILABILITY_OF_RESOURCES" },
		{ 119, "ETT_AVAILABILITY_OF_CONTRACT" },
		{ 120, "ETT_AVAILABILITY_OF_USER_CENTRIC_CONTRACT" },
		{ 121, "ETT_AS3DATE" },
		{ 122, "ETT_IOIACCOUNT_STATUS" },
		{ 123, "ETT_ISCONTRACT_IN_PLAYLIST" },
		{ 124, "ETT_ISCONTRACT_IN_PLAYLIST_MARKED_FOR_DELETION" },
		{ 125, "ETT_VIDEOMEMORYINFO_IS_SUPPORTED" },
		{ 126, "ETT_VIDEOMEMORYINFO" },
		{ 127, "ETT_DISPLAY_SIZE" },
		{ 128, "ETT_IS_VIDEO_VALID" },
		{ 129, "ETT_INTEL_IDS" },
		{ 130, "ETT_INTEL_DETAILS" },
		{ 131, "ETT_MENU_CONFIGURATION" },
		{ 132, "ETT_HERO_INVENTORY" },
		{ 133, "ETT_MAP_TRACKERINFO" },
		{ 134, "ETT_WAS_EXITGATE_TRIGGERED" },
		{ 135, "ETT_ARE_OPPORTUNITIES_ENABLED" },
		{ 136, "ETT_CHARACTERS" },
		{ 137, "ETT_CHARACTERINFO" },
		{ 138, "ETT_DATABINDING" },
		{ 139, "ETT_DATABINDING_ROOT" },
		{ 140, "ETT_ALLOWED_UNLOCKABLES" },
		{ 141, "ETT_HAS_FRAMERATE_OPTION" },
		{ 142, "ETT_MENU_DATAPROVIDER" },
		{ 143, "ETT_INTERACTIONINDICATOR" },
		{ 144, "ETT_NVIDIAHIGHLIGHTSAVAILABLE" },
		{ 145, "ETT_NVIDIAHIGHLIGHTSHASHIGHLIGHTS" },
		{ 146, "ETT_DEBUG_ALLHITMANSUITS" },
	};
	...
	(*g_Enums)["ZOnlineManager.EError"] = {
		...
		{ 1013, "eAUTHENTICATION_GOG_GENERAL" },
		{ 1014, "eAUTHENTICATION_PSN_GENERAL" },
		{ 1015, "eAUTHENTICATION_PSN_NP_CHECK" },
		{ 1016, "eAUTHENTICATION_PSN_ACCOUNT_COLLISION" },
		{ 1017, "eAUTHENTICATION_NO_PRIMARY_USER" },
		{ 1018, "eAUTHENTICATION_XBLIVE_GENERAL" },
		{ 1019, "eAUTHENTICATION_XBLIVE_SIGNED_OUT" },
		{ 1020, "eAUTHENTICATION_XBLIVE_USER_CHANGED" },
		{ 1021, "eAUTHENTICATION_STADIA_GENERAL" },
		{ 1022, "ePLATFORM_USERINFO" },
		{ 1023, "eCONFIGURATION" },
		{ 1024, "eENTITLEMENTS" },
		{ 1025, "ePROFILE" },
		{ 1026, "eGAME_SESSION" },
		{ 1027, "eCLIENT_OUTDATED" },
		{ 1028, "eGENERAL_SERVER_ERROR" },
		{ 1029, "eGENERAL_SERVER_BUSY" },
		{ 1030, "eGENERAL_CLIENT_ERROR" },
		{ 1031, "eDYNAMIC_RESOURCES_CONFIG_ERROR" },
		{ 1032, "eDYNAMIC_RESOURCES_UPDATEFAILED" },
		{ 1033, "eDYNAMIC_RESOURCES_OUTDATED" },
		{ 1034, "eFSP_IOI_ACCOUNT_SIGNUP_REQUIRED" },
		{ 1035, "eFSP_IOI_ACCOUNT_SIGNUP_ERROR" },
		{ 1036, "eCANCELLED" },
		{ 1037, "eERROR_MAX" },
	};
