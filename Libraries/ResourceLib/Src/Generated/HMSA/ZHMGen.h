...
public:
	...
	TFixedArray<EAIGoal, 30> m_aGoalKeys; // 0x18
	TFixedArray<SActorGoalSaveData, 30> m_aGoals; // 0x90
	float32 m_fHMAttention; // 0xBD0
	float32 m_fHMAttentionLastUpdate; // 0xBD4
	float32 m_fHMDisguiseAttention; // 0xBD8
	float32 m_fHMTrespassingAttention; // 0xBDC
	float32 m_fHMLastTrespassingAttentionMax; // 0xBE0
	ZGameTime m_tLastTrespassingAttentionGain; // 0xBE8
	ZGameTime m_tLastAttentionEvaluate; // 0xBF0
	float32 m_fHMWeaponAttention; // 0xBF8
	float32 m_fHMWeaponAttentionChange; // 0xBFC
	EGameTension m_eGameTension; // 0xC00
	ZGameTime m_tAmbientStartTime; // 0xC08
	ZGameTime m_tExpiredAIModifierSuppressSocialGreeting; // 0xC10
	uint32 m_behaviorModifiers; // 0xC18
};
...
public:
	...
	ZRepositoryID m_OutfitRepositoryId; // 0xCB8
	int32 m_nOutfitCharset; // 0xCC8
	int32 m_nOutfitVariation; // 0xCCC
	ZGameTime m_tSequenceEndTime; // 0xCD0
	EActorState m_nState; // 0xCD8
	uint32 m_rBodyContainerEntity; // 0xCDC
	int32 m_nBodyContainerSlot; // 0xCE0
	EActorEmotionState m_eEmotionState; // 0xCE4
	uint32 m_rCorpseBodybagEntity; // 0xCE8
	uint32 m_rDragBodybagEntity; // 0xCEC
	SActorDamageControlSaveData m_ActorDamageControlData; // 0xCF0
	ZVariant m_AnimatedActorOrderData; // 0xD50
	float32 m_fStepsFraction; // 0xD60
	float32 m_fZBeforeEnteringStairs; // 0xD64
	TArray<SActorDynamicTemplateSaveData> m_aDynamicTemplates; // 0xD68
	SMatrix m_sEndOrientation; // 0xD80
	EActorAIState m_eOverrideSensorState; // 0xDC0
	EDeathBehavior m_eDeathBehavior; // 0xDC4
	SEventHistorySaveData m_bumpsHistory; // 0xDC8
	SActorRagdollPoseSaveData m_RagdollPose; // 0xDE0
	TArray<SLongTermMemorySaveData> m_aLongTermMemorySaveData; // 0xE20
	uint32 m_AgentData; // 0xE38
	bool m_HadValidAgent; // 0xE3C
	bool m_bNude; // 0xE3D
	bool m_bActiveEnforcer; // 0xE3E
	bool m_bIsPotentialEnforcer; // 0xE3F
	bool m_bDynamicEnforcer; // 0xE40
	bool m_bIsCrowdCharacter; // 0xE41
	bool m_bIsWoozy; // 0xE42
	bool m_bBlendingOrientation; // 0xE43
	bool m_bMakeMainWeaponUndroppable; // 0xE44
	bool m_bWeaponIsHidden; // 0xE45
	bool m_bRegisteredForLT; // 0xE46
	bool m_bKeepOverrideSensorStateAfterBeingUnconscious; // 0xE47
	bool m_bWeaponReady; // 0xE48
	bool m_bDynamicWeaponUnholstered; // 0xE49
	bool m_bForceInteractionGlow; // 0xE4A
	bool m_bIsOutfitRuined; // 0xE4B
};
...
public:
	...
	SActorSoundDefs_EDefinition m_sound; // 0x4
};
...
public:
	...
	uint32 m_nPieceIndex; // 0x0
	TArray<uint32> m_aConnections; // 0x8
};
...
public:
	...
	TArray<SDestructiblePieceSaveData> m_aDestructiblePieces; // 0x0
	TArray<SDestructibleRuntimeConnnection> m_aConnectionData; // 0x18
	TArray<SDestructibleRuntimeDamage> m_aDamageData; // 0x30
	uint32 m_nNumAnchors; // 0x48
	bool m_bHasSystemBeenDetached; // 0x4C
	bool m_bHasSystemBeenFractured; // 0x4D
};
...
public:
	...
	ZScreenplay2_EScreenPlayState m_eState; // 0x4
...
public:
	...
	uint32 m_pPreviousOwner; // 0x50
	bool m_bTurnedOn; // 0x54
	bool m_bEverOwnedByHitman; // 0x55
	bool m_bWasPlacedAndAttached; // 0x56
	bool m_bObjectInPhysicsWorld; // 0x57
	int32 m_nQuantity; // 0x58
};
...
public:
	...
	bool m_bDropTempHolsterableItems; // 0x51
	float32 m_fNoiseIntensity; // 0x54
	bool m_bRotateIndicator; // 0x58
	SVector2 m_vPosition; // 0x5C
	SVector3 m_vRotation; // 0x64
	bool m_bNeedDataUpdate; // 0x70
	bool m_bNeedAlphaUpdate; // 0x71
};
...
public:
	...
	uint32 m_nAmmoCountGun; // 0x40
	uint32 m_nAmmoCountRevolver; // 0x44
	uint32 m_nAmmoCountSMG; // 0x48
	uint32 m_nAmmoCountRifle; // 0x4C
	uint32 m_nAmmoCountShotgun; // 0x50
	uint32 m_nAmmoCountSniper; // 0x54
	uint32 m_nAmmoCountMG; // 0x58
	uint32 m_nAmmoCountRPG; // 0x5C
	uint32 m_nAmmoCountFake; // 0x60
	uint32 m_nAmmoCountLightPistol; // 0x64
	TArray<ZRepositoryID> m_aAmmoIds; // 0x68
	TArray<uint32> m_aAmmoCounts; // 0x80
};
...
// Size: 0x10
class alignas(4) SInventoryMovementConfig
{
public:
	static ZHMTypeInfo TypeInfo;
	static void WriteJson(void* p_Object, std::ostream& p_Stream);
	...
	EInventoryConfigItemHandling m_eItemHandlingSmall; // 0x0
	EInventoryConfigItemHandling m_eItemHandlingLarge; // 0x4
	EInventoryConfigItemHandling m_eItemHandlingSecondary; // 0x8
	EInventoryConfigFormerEquippedItems m_eFormerEquippedItems; // 0xC
};
...
public:
	...
	SDrama2ActorCollectionSaveData m_DramaActorData; // 0x0
	SDrama2SituationCollectionSaveData m_DramaSituationData; // 0x30
	SDrama2SetupCollectionSaveData m_DramaSetupData; // 0x60
};
...
public:
	...
	TArray<SEntityTemplateExposedEntity> exposedEntities; // 0x58
...
// Size: 0x18
class alignas(8) SVaultSlotSaveData
{
public:
	static ZHMTypeInfo TypeInfo;
	static void WriteJson(void* p_Object, std::ostream& p_Stream);
	...
	bool operator==(const SVaultSlotSaveData& p_Other) const;
	bool operator!=(const SVaultSlotSaveData& p_Other) const { return !(*this == p_Other); }

	TArray<uint32> m_aStorage; // 0x0
};
...
public:
	...
	ZRuntimeResourceID icon; // 0x0
	ZString sWeaponName; // 0x8
	int32 nWeaponType; // 0x18
	int32 nAmmoRemaining; // 0x1C
	int32 nAmmoTotal; // 0x20
	int32 nAmmoInClip; // 0x24
	bool bSilenced; // 0x28
	bool bIsFirearm; // 0x29
	bool bHolstered; // 0x2A
	bool bCannotBeHolstered; // 0x2B
	bool bHasItemToShow; // 0x2C
	bool bSuspicious; // 0x2D
	bool bIllegal; // 0x2E
	bool bCanReload; // 0x2F
	bool bIsReloading; // 0x30
	bool bInfiniteAmmo; // 0x31
	float32 fLastBulletFiredTime; // 0x34
	float32 fTimeBetweenBullets; // 0x38
	TArray<ZString> aPerks; // 0x40
	TArray<ZString> aAmmoTypes; // 0x58
	uint32 nCurrentAmmoType; // 0x70
};
...
public:
	...
	TArray<uint32> m_aDistractedActors; // 0x0
	ZGameTime m_StartTime; // 0x18
};
...
public:
	...
	SItemOnBackUIData itemOnBackStatus; // 0x78
	bool bShowHolstered; // 0x84
};
...
// Size: 0xC8
class alignas(8) ZSlotDefinition
{
public:
	static ZHMTypeInfo TypeInfo;
	static void WriteJson(void* p_Object, std::ostream& p_Stream);
	...
	bool operator==(const ZSlotDefinition& p_Other) const;
	bool operator!=(const ZSlotDefinition& p_Other) const { return !(*this == p_Other); }
